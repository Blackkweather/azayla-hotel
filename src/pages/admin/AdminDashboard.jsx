...
import {
  Plus, Edit2, Trash2, Eye, EyeOff, LogOut, ExternalLink,
...
export default function AdminDashboard({ session }) {
  ...
  return (
    <div className="min-h-screen bg-[#f7f6f3] pb-24 sm:pb-0">
                  ...
                  >
                    ...
                    <div className="p-4 sm:p-5">
                      <div className="flex items-start justify-between gap-2 mb-1">
                        <h3
                          className="font-cormorant text-[1.1rem] font-semibold text-deep-blue leading-tight cursor-pointer hover:text-terracotta transition-colors"
                      ...
                      <div className="flex gap-2 pt-3 border-t border-gray-50">
                        <button
                          onClick={() => openEdit(room)}
                          className="flex-1 flex items-center justify-center gap-1.5 py-2.5 sm:py-2 rounded-xl bg-deep-blue/5 hover:bg-deep-blue/10 text-deep-blue text-xs font-semibold transition-colors"
                        >
                          <Edit2 size={13} /> Edit
                        </button>
                        <button
                        ...
                        <button
                          ...
                          className="w-10 h-10 flex items-center justify-center rounded-xl bg-red-50 hover:bg-red-100 text-red-400 hover:text-red-600 transition-colors disabled:opacity-40"
                        >
                          <Trash2 size={14} />
                        </button>
                      </div>
      ...
      {modalOpen && (
        <RoomModal room={editingRoom} onSaved={handleSaved} onClose={() => setModalOpen(false)} />
      )}
    </div>
  )
}
